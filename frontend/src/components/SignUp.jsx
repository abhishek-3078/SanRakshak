  ...
  const LogUser = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API}/user/signup`, {
        ...
        body: JSON.stringify(SignUpData) //grid-template-columns: 2fr 1fr
      });
        ...
        <div className="mx-auto w-4/5 md:w-1/2 md:pr-4">
          <div className="w-full">
            ...
            <div className="grid grid-cols-2 gap-4 items-end">
              <div className="border-solid border-2 border-black rounded-sm col-span-2">
                <input
            ...
            <button onClick={LogUser} className="bg-red-400 mx-auto block md:left-0 md:inline-block rounded-md py-2 px-2 text-white mt-3  mb-3 hover:bg-red-500 duration-200">
              Register Now
            </button>
          </div>
        </div>
