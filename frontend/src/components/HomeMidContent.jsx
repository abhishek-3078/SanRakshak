  ...
  return (
    <div className='w-full mb-4'>
      ...
      <div className='flex flex-row justify-evenly w-3/4 mx-auto'>
        <div className='border-2 border-solid border-gray-400 rounded-md w-1/4 py-2 px-6 hover:scale-105 duration-200 hover:shadow-lg shadow-md shadow-gray-500' data-aos="zoom-in" data-aos-delay="100" >
            <div className='my-1' >
        ...
        <d className='border-2 border-solid border-gray-400 rounded-md w-1/4 py-2 px-6 hover:scale-105 duration-200 hover:shadow-lg shadow-md shadow-gray-500' data-aos="zoom-in" data-aos-delay="330">
            <div className='my-1'>
        ...
        <d className='border-2 border-solid border-gray-400 rounded-md w-1/4 py-2 px-6 hover:scale-105 duration-200 hover:shadow-lg shadow-md shadow-gray-500' data-aos="zoom-in" data-aos-delay="560">
            <div className='my-1'>
