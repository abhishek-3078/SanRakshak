...
function App() {
  ...
  return (
    <div className="bg-gradient-to-r flex from-indigo-500 rounded-2xl items-center h-full md:h-screen md:w-screen  m-auto">
      ...
      <div className="w-5/6 md:w-8/12 py-0 px-0 md:py-10 md:px-8 bg-white rounded-xl mx-auto flex shadow-lg flex-col my-5 md:my-auto items-center relative md:flex-row">
        ...
        <div className="mx-auto w-4/5 md:w-1/2 md:pr-4">
          <div className="w-full">
            ...
            <button onClick={LogUser} className="bg-blue-400 mx-auto block md:left-0 md:inline-block rounded-md p-2 text-white mt-3  mb-3 hover:bg-blue-500 duration-200">
              Register Now
            </button>
          </div>
        </div>
