...
function AdminAddress() {
    ...
    return (
        <>
            {formMode ? <section className="border-2 border-solid border-[#C5C5C5] w-screen rounded-xl h-screen px-10 py-10 overflow-auto">
                <div>
                ...
                <div className="flex flex-col items-center border-2 border-solid border-[#C5C5C5] w-screen rounded-xl h-screen px-10 py-10 overflow-auto">
                    {/* hello */}
