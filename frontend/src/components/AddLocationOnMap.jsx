        ...
        <section className="w-[100%] h-[80vh] border-2 border-solid border-[grey] rounded-xl px-5 py-2">
            ...
            <div className="my-5">
                <div className="relative">
                    <input type="search" autoComplete="off" name="search" id="search" onFocus={()=>setIsOnFocus(true)} onBlur={()=>setIsOnFocus(false)} placeholder="search location" className="border-2 border-solid border-[grey] p-2  h-8 rounded-2xl" />
            ...
            <div className="w-full border-[1px] border-solid border-[grey] my-5 rounded-lg overflow-hidden">
